...
public class MemberDAO {
    ...
    private static final String URL
        = "jdbc:mysql://localhost:3306/hahaha";
    ...
    public boolean insertMember(MemberDTO dto){
        ...
        try{
            ...
            ps.setDouble(8, dto.getHeight());
            ps.setDouble(9, dto.getWeight());   
            ps.setString(10, dto.getBmi()); 
    ...
    public boolean updateMember(MemberDTO vMem){
        ...
        try{
            ...
            con = getConn();           
            String sql = "update tb_member set name=?, tel=?, addr=?, birth=?,  gender=?" +
                    ", height=?, weight=?, bmi=? "+ "where id=? and pwd=?";
            ...
            ps.setDouble(6, vMem.getHeight());
            ps.setDouble(7, vMem.getWeight());
            ps.setString(8, vMem.getBmi());
